 ...
 * Purpose: Java Guessing Game that asks user to guess randomly
 * generated number between 1 and 100. It also saves statistics
 * such as number of games, number of guesses, average guesses 
 * per game, etc.
 */
